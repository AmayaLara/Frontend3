...
export default class App extends React.Component {
  ...
  handleChange = (opcion) => {
    i++
    let caminoElegido = data.filter(data => data.id === i + opcion)[0]
    if(i === 6){
      alert("FIN!")
    }
    else{
      this.setState((prevState) => ({
        ...
        opcionesSeleccionadas: [...prevState.opcionesSeleccionadas, opcion.toUpperCase()],
      }))
    }
  }
  ...
  render(){
    ...
    <div className="App">
      <div className="layout">
        ...
        <Botones recibirSeleccion ={this.handleChange}  opcionA={this.state.opcionA} opcionB={this.state.opcionB} />
        <Recordatorio opcionAnterior= {this.state.opcionAnterior} opcionesSeleccionadas={this.state.opcionesSeleccionadas}/>
        <br/>
